...
#[derive(Debug, Deserialize, Serialize, utoipa::ToSchema, utoipa::ToResponse)]
...
#[debug_handler]
#[utoipa::path(post, path = "/api/auth/register")]
async fn register(
...
/// the system.
#[debug_handler]
#[utoipa::path(get, path = "/api/auth/verify/{token}")]
...
/// list).
#[debug_handler]
#[utoipa::path(post, path = "/api/auth/forgot")]
async fn forgot(
    State(ctx): State<AppContext>,
...
#[debug_handler]
#[utoipa::path(post, path = "/api/auth/reset")]
...
#[debug_handler]
#[utoipa::path(post, path = "/api/auth/login", responses((status = 200, body = LoginResponse)))]
...
#[debug_handler]
#[utoipa::path(get, path = "/api/auth/current", responses((status = 200, body = CurrentResponse)))]
...
#[utoipa::path(post, path = "/api/auth/magic-link")]
async fn magic_link(
    State(ctx): State<AppContext>,
...
#[utoipa::path(get, path = "/api/auth/magic-link/{token}", responses((status = 200, body = LoginResponse)))]
...
#[utoipa::path(post, path = "/api/auth/resend-verification-email")]
#[debug_handler]
